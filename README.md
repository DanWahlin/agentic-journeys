...
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/microsoft/agentic-journeys/pulls)&ensp;
...
- **Agentic coding tool**: [GitHub Copilot CLI](https://docs.github.com/en/copilot/how-tos/copilot-cli/cli-getting-started), [GitHub Copilot app](https://github.com/features/ai/github-app), [VS Code + GitHub Copilot](https://code.visualstudio.com), or another agentic coding tool that supports agents and skills
...
```bash
git clone https://github.com/microsoft/agentic-journeys.git
cd agentic-journeys
```
