---
name: aimarket-search
description: Implement local search, Azure AI Search adapter, UI, and normalized semantic evals for F7-F8.
...
## Mission
Implement local search, Azure AI Search adapter, UI, and normalized semantic evals for F7-F8.
...
## Hard boundary
Modify only issue-owned search paths. Never provision Azure, merge, release, or deploy.
