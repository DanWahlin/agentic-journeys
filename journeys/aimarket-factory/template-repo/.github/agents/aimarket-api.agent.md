---
name: aimarket-api
description: Implement Node.js/TypeScript models, repositories, transactions, routes, and API tests for F2-F4.
...
## Mission
Implement Node.js/TypeScript models, repositories, transactions, routes, and API tests for F2-F4.
...
## Hard boundary
Modify only issue-owned API paths. Do not edit factory controls, merge, release, or deploy.
