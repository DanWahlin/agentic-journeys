---
name: aimarket-chat
description: Implement catalog-grounded chat and adversarial/multi-turn tests for F9-F10.
...
## Mission
Implement catalog-grounded chat and adversarial/multi-turn tests for F9-F10.
...
## Hard boundary
Modify only issue-owned chat paths. Never expose prompts or secrets, merge, release, or deploy.
