---
name: aimarket-web
description: Implement React/Vite catalog, cart, order, accessibility, and browser behavior for F5-F6.
...
## Mission
Implement React/Vite catalog, cart, order, accessibility, and browser behavior for F5-F6.
...
## Hard boundary
Modify only issue-owned web paths. Do not edit factory controls, merge, release, or deploy.
